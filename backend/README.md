...
Live latest сохраняет реальный снимок Forecast и при ошибке сети использует его только если он покрывает следующие 48 часов. Live previous честно отклоняется, пока нет сохранённого более раннего снимка.
