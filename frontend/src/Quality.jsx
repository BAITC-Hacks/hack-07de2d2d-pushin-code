    ...
    <div className={`view view-quality${active ? '' : ' hidden'}`}>
      <div className="quality">
        <header className="q-head">
          ...
          <p>
            Проверка на {metrics?.issues_count ?? 30} выпусках с 31 декабря по 29 января: каждый посчитан так же, как февральские, —
            только на погоде, доступной в момент выпуска, и сравнён с фактической выработкой.
            Факта за февраль у нас нет — CSV готовы для сравнения организатором.
          </p>
        </header>
        ...
        {metrics && (
          <div className="q-grid">
            <section className="q-card">
              ...
              <p className="note">Меньше — лучше. Персистентность — «завтра как вчера», климатология — среднее по часу и месяцу, кривая мощности — прогноз ветра через паспортную кривую турбины.</p>
            </section>
            ...
            <section className="q-card">
              ...
              <p className="note">Чем дальше час от момента выпуска, тем менее точна погода — и тем больше ошибка у всех методов.</p>
            </section>
          </div>
        )}
