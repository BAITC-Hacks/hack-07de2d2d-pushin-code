...
const CHECKS = [
  ...
  { need: 'Насколько прогноз уверен в себе', where: 'Светлая полоса вокруг линии прогноза — вероятный диапазон: с вероятностью 80 % выработка будет в нём', tab: 'february', target: 'forecast-chart' },
